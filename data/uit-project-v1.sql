...
COPY public.ojt_comment (id, created_at, updated_at, content, is_deleted, user_id, comment_id, event_detail_id) FROM stdin;
\.
...
COPY public.ojt_event (id, created_at, updated_at, status, detail_id, student_id) FROM stdin;
2	2024-03-19 10:27:44.03513	2024-03-19 10:27:44.03513	2	2	1
3	2024-03-19 10:27:44.037546	2024-03-19 10:27:44.037546	2	3	2
4	2024-03-19 10:27:44.039586	2024-03-19 10:27:44.039586	1	4	2
1	2024-03-19 10:26:28.333644	2024-03-19 10:26:28.333644	1	1	1
\.
...
SELECT pg_catalog.setval('public.ojt_comment_id_seq', 1, false);
...
--
-- Name: ojt_comment uk_fpb57d604muieiy8r4x57d6ly; Type: CONSTRAINT; Schema: public; Owner: tuan908
--

ALTER TABLE ONLY public.ojt_comment
    ADD CONSTRAINT uk_fpb57d604muieiy8r4x57d6ly UNIQUE (comment_id);


--
-- Name: ojt_comment uk_g2qtah8axxpdr35e80n65i21q; Type: CONSTRAINT; Schema: public; Owner: tuan908
--

ALTER TABLE ONLY public.ojt_comment
    ADD CONSTRAINT uk_g2qtah8axxpdr35e80n65i21q UNIQUE (user_id);
...
--
-- Name: ojt_comment fkqm4ngu6xvi91lge17xcokga9o; Type: FK CONSTRAINT; Schema: public; Owner: tuan908
--

ALTER TABLE ONLY public.ojt_comment
    ADD CONSTRAINT fkqm4ngu6xvi91lge17xcokga9o FOREIGN KEY (comment_id) REFERENCES public.ojt_event(id);
