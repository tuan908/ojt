...
import BubbleMessage from "@/components/ui/bubble-message";
import { type SelectOption } from "@/components/ui/legacy/select";
...
type EventDetailContentProps = Partial<{
                ...
                <div className="w-4/5 md:w-1/2 m-auto bg-white rounded-xl shadow-sm">
                    <div className="w-[90%] m-auto flex flex-col gap-y-4 py-6">
                        ...
                        [
                            ...
                            <button
                                className="w-full border-none px-4 py-2 text-white rounded-md m-auto hover:cursor-pointer disabled:cursor-not-allowed"
