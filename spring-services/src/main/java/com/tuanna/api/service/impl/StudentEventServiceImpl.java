...
public class StudentEventServiceImpl implements StudentEventService {
  ...
  @Override
  @Transactional
  public ApiResponse<CreateDto> create(RegisterEventDto dto) {
    ...
    var response = new CreateDto(event.getId());
  ...
  public ApiResponse<Object> update(UpdateStudentEventDto dto) {
    ...
    sql.append("  e                                     ");
    sql.append("from                                    ");
    sql.append("  com.tuanna.api.entity.EventDetail e   ");
    sql.append("where                                   ");
    sql.append("  e.student.code = :code                ");
    sql.append("  and e.student.grade.name = :gradeName ");
    sql.append("  and e.detail.name = :eventName        ");
    sql.append("  and e.isDeleted = false               ");
