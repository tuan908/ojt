...
public class StudentController {
  ...
  @ResponseBody
  public ResponseEntity<?> update(@PathVariable String studentCode,
      @RequestBody RegisterEventDto dto) {
  ...
  public ResponseEntity<?> updateStatus(@PathVariable String studentCode,
      @PathVariable Long eventId, @RequestBody UpdateEventStatusDto dto) {
  ...
  public ResponseEntity<?> findByStudentCodeEventId(@PathVariable String studentCode,
  ...
  public ResponseEntity<ApiResponse<?>> deleteComment(@PathVariable String studentCode,
